...
Neben der Unterscheidung in den Jahren sollen zudem die Unterschiede der Ausgangslöhne herausgestelltt werden. \
...
Es wir deutlich, dass vorallem in den unteren 13 Perzentilen von der Mindestlohneinführung profitiert wird und die Unterschiede in der Lohnerhöhung am Größten sind.
------
...
success: Richtige Antwort. 
failure: Leider flasch. Wieso sollte die Marge geringer sein, wenn die Gruppe - vereinfacht dargestellt - doch gar nicht vom Treatment betroffen ist?
#>
...
#< quiz "3.3.8"
question: Eine Variable, die den Lohn negativ beeinflusst, ist der Anteil der Gewerkschaftsmitglieder *unionmem*. Woran könnte das liegen?
sc:
    - Das Jahr 1997 ist sinnvoll gewählt, da es den Startpunkt unserer Analyse markiert. 
    - Es gibt andere Jahre, die auf Basis unserer Analyse einen wichtigeren Punkt markieren*
...
- Aarts, Emmeke, et al. "A solution to dependency: using multilevel analysis to accommodate nested data." Nature neuroscience 17.4 (2014): 491-496.
