...
Im Mittelpunkt der Mindestlohneinführung steht der Wert von 3.60 Pfund pro Stunde. Wir sollten also in unsere Treatmentgruppe jene Mitarbeiter einschließen, die vor der Mindestlohneinführung einen Lohn unter 3.60£ erhalten.
...
Nicht alle vom Mindestlohn profitierenden Arbeitnehmer werden in der Treatmentgruppe abgebildet. Dennoch kommen die Autoren zu dem Schluss, dass mit 87% jener Arbeitnehmer Teil der Treatmentgruppe sind. 
(Draca et al., S. 137f.)
...
Erstllen Sie auf Basis des Datensatzes *dat* eine Tabelle, die alle relevanten Daten für eine händische Berechnung enthält.
...
Wenn Sie sich den obigen Code nochmals ansehen, können Sie eine noch nicht eingeführte Variable erkennen. Der Datensatz wird hier anhand der Variablen "pp" gefiltert.
...
Im Vereinigten Königreich sind kleinere Unternehmen von der Veröffentlichung bestimmter Daten befreit. Um eine vollumfängliche Analyse zu gewährleisten, entscheiden sich die Autoren daher ein Unterbeispiel zu erstellen, in denen Daten vollständig erfasst werden (Draca et al., S. 135, Verw. 13).
...
Interessant dabei sind die sogenannten Confounder, die sowohl die abhängige, als auch eine beschreibende Variable beeinflussen. (International Journal of Epidemiology, 2021, Vol. 50, No. 2, S. 622)
