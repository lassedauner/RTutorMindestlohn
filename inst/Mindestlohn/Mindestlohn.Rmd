...
**DiD-Methode**
Die DiD-Schätzung ist häufig geeignet, um politische Maßnahmen empirisch zu beurteilen. Gerade mit Hinblick auf Lohnentwicklungen stellte die Methode bereits in der Vergangenheit eine wichtige Grundlage.  (Angrist, J. D., & Pischke, J. S. (2009). Mostly harmless econometrics: An empiricist's companion. Princeton university press.)

**Sind die Voraussetzungen gegeben? (Quiz)**
Um eine DiD-Schätzung durchführen zu können, müssen vier relevante Gruppen definiert werden.
...
Die Wahl der Treatmentgruppe kann allerdings weiter durch die Verwendung des WERS-Datensatzes untermauert werden. So kann die Lohnverteilung innerhalb eines Unternehmens mit dem Durchschnittslohn in Zusammenhang gebracht werden.
...
```{r "12_c",optional=TRUE, dev='svg', fig.width=4}
